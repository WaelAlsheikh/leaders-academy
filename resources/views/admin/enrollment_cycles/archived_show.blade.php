...
<div class="container-fluid">
    ...
    <div style="margin-bottom:15px; display:flex; gap:10px; flex-wrap:wrap;">
        ...
        <form method="POST" action="{{ route('admin.archived_enrollment_cycles.restore', $cycle) }}" style="display:inline-block;" onsubmit="return confirm('هل تريد استعادة هذه الدورة؟');">
            @csrf
    ...
    <div class="panel panel-bordered" style="margin-top:20px;">
        <div class="panel-body">
            ...
            <form method="GET" action="{{ route('admin.archived_enrollment_cycles.show', $cycle) }}" class="row" style="margin-bottom:10px;">
                <div class="col-md-3">
                ...
                <div class="col-md-3" style="margin-top:25px;">
                    ...
                    <a href="{{ route('admin.archived_enrollment_cycles.show', $cycle) }}" class="btn btn-default">إزالة</a>
                </div>
            </form>
