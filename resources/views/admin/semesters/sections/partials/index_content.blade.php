<div class="container-fluid">
    ...
    <div class="panel panel-bordered" style="padding:15px;">
        <h4>إضافة شعبة</h4>
        <form method="POST" action="{{ route($routeBase . '.semesters.sections.store', $semester) }}">
            @csrf
            <div class="row">
                <div class="col-md-4">
                    <label>المادة</label>
                ...
                <tbody>
                    @foreach($semester->classSections as $section)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route($routeBase . '.sections.meetings.index', $section) }}" class="btn btn-xs btn-primary">
                                ...
                                <form method="POST" action="{{ route($routeBase . '.sections.destroy', $section) }}" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <tr id="edit-section-{{ $section->id }}" class="collapse">
                            <td colspan="7" style="background:#f9f9f9;">
                                <form method="POST" action="{{ route($routeBase . '.sections.update', $section) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-2">
